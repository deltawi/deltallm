...
run_script "$SCRIPTS_DIR/08_setup_self_service.sh"
run_script "$SCRIPTS_DIR/09_test_self_service_create.sh"
run_script "$SCRIPTS_DIR/10_test_self_service_listing.sh"
run_script "$SCRIPTS_DIR/11_test_self_service_lifecycle.sh"
run_script "$SCRIPTS_DIR/12_test_self_service_audit.sh"
