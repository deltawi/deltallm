-- Previous release schema snapshot for PR 3 upgrade-path validation.
...
--
-- Name: DeltaLLM_BatchJobStatus; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE "public"."DeltaLLM_BatchJobStatus" AS ENUM (
    'queued',
    'in_progress',
    'finalizing',
    'completed',
...
CREATE TABLE "public"."deltallm_batch_completion_outbox" (
    "completion_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
--
-- Name: deltallm_batch_create_session; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE "public"."deltallm_batch_create_session" (
    ...
    CONSTRAINT "deltallm_batch_create_session_idempotency_key_not_blank_chk" CHECK ((("idempotency_key" IS NULL) OR ("btrim"("idempotency_key") <> ''::"text"))),
    CONSTRAINT "deltallm_batch_create_session_idempotency_pair_chk" CHECK (((("idempotency_scope_key" IS NULL) AND ("idempotency_key" IS NULL)) OR (("idempotency_scope_key" IS NOT NULL) AND ("idempotency_key" IS NOT NULL)))),
    CONSTRAINT "deltallm_batch_create_session_idempotency_scope_not_blank_chk" CHECK ((("idempotency_scope_key" IS NULL) OR ("btrim"("idempotency_scope_key") <> ''::"text"))),
    CONSTRAINT "deltallm_batch_create_session_status_chk" CHECK (("status" = ANY (ARRAY['staged'::"text", 'completed'::"text", 'failed_retryable'::"text", 'failed_permanent'::"text", 'expired'::"text"])))
);
...
CREATE TABLE "public"."deltallm_batch_file" (
    "file_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_batch_item" (
    "item_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "batch_id" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_batch_job" (
    "batch_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "endpoint" "text" NOT NULL,
    "status" "public"."DeltaLLM_BatchJobStatus" NOT NULL,
...
CREATE TABLE "public"."deltallm_callabletargetbinding" (
    "callable_target_binding_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_callabletargetscopepolicy" (
    "callable_target_scope_policy_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "scope_type" "text" NOT NULL,
    "scope_id" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_mcpapprovalrequest" (
    ...
    "updated_at" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "expires_at" timestamp(3) without time zone,
    CONSTRAINT "deltallm_mcpapprovalrequest_status_chk" CHECK (("status" = ANY (ARRAY['pending'::"text", 'approved'::"text", 'rejected'::"text", 'expired'::"text"])))
);
...
CREATE TABLE "public"."deltallm_mcpbinding" (
    ...
    "scope_id" "text" NOT NULL,
    "enabled" boolean DEFAULT true NOT NULL,
    "tool_allowlist" "text"[] DEFAULT ARRAY[]::"text"[] NOT NULL,
    "metadata" "jsonb",
    "created_at" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    "updated_at" timestamp(3) without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
CREATE TABLE "public"."deltallm_mcpscopepolicy" (
    "mcp_scope_policy_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "scope_type" "text" NOT NULL,
    "scope_id" "text" NOT NULL,
    "mode" "text" DEFAULT 'inherit'::"text" NOT NULL,
    "metadata" "jsonb",
...
CREATE TABLE "public"."deltallm_mcpserver" (
    ...
    "auth_config" "jsonb",
    "forwarded_headers_allowlist" "text"[] DEFAULT ARRAY[]::"text"[] NOT NULL,
    ...
    "owner_scope_id" "text",
    CONSTRAINT "deltallm_mcpserver_owner_scope_chk" CHECK (((("owner_scope_type" = 'global'::"text") AND ("owner_scope_id" IS NULL)) OR (("owner_scope_type" = 'organization'::"text") AND ("owner_scope_id" IS NOT NULL))))
);
...
CREATE TABLE "public"."deltallm_organizationmembership" (
    "membership_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "account_id" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_platformaccount" (
    "account_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "email" "text" NOT NULL,
    "password_hash" "text",
...
CREATE TABLE "public"."deltallm_platformidentity" (
    "identity_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "account_id" "text" NOT NULL,
    "provider" "text" NOT NULL,
    "subject" "text" NOT NULL,
    "email" "text",
...
CREATE TABLE "public"."deltallm_promptbinding" (
    "prompt_binding_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "scope_type" "text" NOT NULL,
    "scope_id" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_promptlabel" (
    "prompt_label_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "prompt_template_id" "text" NOT NULL,
    "label" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_promptrenderlog" (
    "prompt_render_log_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "request_id" "text",
    "api_key" "text",
    "user_id" "text",
    "team_id" "text",
...
CREATE TABLE "public"."deltallm_prompttemplate" (
    "prompt_template_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_promptversion" (
    "prompt_version_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "prompt_template_id" "text" NOT NULL,
...
CREATE TABLE "public"."deltallm_routegroup" (
    "route_group_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_routegroupbinding" (
    "route_group_binding_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_routepolicy" (
    "route_policy_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "route_group_id" "text" NOT NULL,
    "version" integer NOT NULL,
    "status" "text" DEFAULT 'draft'::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_serviceaccount" (
    "service_account_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
...
CREATE TABLE "public"."deltallm_teamtable" (
    "team_id" "text" DEFAULT ("gen_random_uuid"())::"text" NOT NULL,
    "team_alias" "text",
    "organization_id" "text",
    "max_budget" double precision,
    "soft_budget" double precision,
    ...
    "rpd_limit" integer,
    "tpd_limit" integer,
    "self_service_keys_enabled" boolean DEFAULT false,
    "self_service_max_keys_per_user" integer,
    "self_service_budget_ceiling" double precision,
    "self_service_require_expiry" boolean DEFAULT false,
...
CREATE TABLE "public"."deltallm_verificationtoken" (
    ...
    "rpd_limit" integer,
    "tpd_limit" integer,
    CONSTRAINT "deltallm_verificationtoken_owner_at_most_one_chk" CHECK (((
CASE
    WHEN ("owner_account_id" IS NOT NULL) THEN 1
    ELSE 0
END +
CASE
    WHEN ("owner_service_account_id" IS NOT NULL) THEN 1
    ELSE 0
END) <= 1))
);
...
--
-- Name: deltallm_batch_create_session deltallm_batch_create_session_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_batch_create_session"
    ADD CONSTRAINT "deltallm_batch_create_session_pkey" PRIMARY KEY ("session_id");
...
--
-- Name: deltallm_prompttemplate deltallm_prompttemplate_template_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_prompttemplate"
    ADD CONSTRAINT "deltallm_prompttemplate_template_key_key" UNIQUE ("template_key");
...
--
-- Name: deltallm_batch_create_session_api_key_status_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_api_key_status_created_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("created_by_api_key", "status", "created_at");


--
-- Name: deltallm_batch_create_session_expires_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_expires_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("expires_at");


--
-- Name: deltallm_batch_create_session_idempotency_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "deltallm_batch_create_session_idempotency_key" ON "public"."deltallm_batch_create_session" USING "btree" ("idempotency_scope_key", "idempotency_key");


--
-- Name: deltallm_batch_create_session_input_file_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_input_file_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("input_file_id");


--
-- Name: deltallm_batch_create_session_org_status_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_org_status_created_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("created_by_organization_id", "status", "created_at");


--
-- Name: deltallm_batch_create_session_stage_artifact_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_stage_artifact_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("staged_storage_backend", "staged_storage_key");


--
-- Name: deltallm_batch_create_session_status_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_status_created_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("status", "created_at");


--
-- Name: deltallm_batch_create_session_target_batch_id_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "deltallm_batch_create_session_target_batch_id_key" ON "public"."deltallm_batch_create_session" USING "btree" ("target_batch_id");


--
-- Name: deltallm_batch_create_session_team_status_created_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_batch_create_session_team_status_created_idx" ON "public"."deltallm_batch_create_session" USING "btree" ("created_by_team_id", "status", "created_at");
...
--
-- Name: deltallm_mcpapproval_fingerprint_status_expires_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_mcpapproval_fingerprint_status_expires_idx" ON "public"."deltallm_mcpapprovalrequest" USING "btree" ("request_fingerprint", "status", "expires_at");


--
-- Name: deltallm_mcpapproval_pending_fingerprint_uniq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX "deltallm_mcpapproval_pending_fingerprint_uniq" ON "public"."deltallm_mcpapprovalrequest" USING "btree" ("request_fingerprint") WHERE ("status" = 'pending'::"text");
...
--
-- Name: deltallm_organizationtable_name_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_organizationtable_name_trgm_idx" ON "public"."deltallm_organizationtable" USING "gin" ("organization_name" "public"."gin_trgm_ops");
...
--
-- Name: deltallm_teamtable_team_alias_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_teamtable_team_alias_trgm_idx" ON "public"."deltallm_teamtable" USING "gin" ("team_alias" "public"."gin_trgm_ops");
...
--
-- Name: deltallm_verificationtoken_key_name_trgm_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX "deltallm_verificationtoken_key_name_trgm_idx" ON "public"."deltallm_verificationtoken" USING "gin" ("key_name" "public"."gin_trgm_ops");
...
--
-- Name: deltallm_auditpayload deltallm_auditpayload_event_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_auditpayload"
    ADD CONSTRAINT "deltallm_auditpayload_event_fk" FOREIGN KEY ("event_id") REFERENCES "public"."deltallm_auditevent"("event_id") ON DELETE CASCADE;


--
-- Name: deltallm_batch_create_session deltallm_batch_create_session_input_file_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_batch_create_session"
    ADD CONSTRAINT "deltallm_batch_create_session_input_file_id_fkey" FOREIGN KEY ("input_file_id") REFERENCES "public"."deltallm_batch_file"("file_id") ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: deltallm_mcpbinding deltallm_mcpbinding_server_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_mcpbinding"
    ADD CONSTRAINT "deltallm_mcpbinding_server_fk" FOREIGN KEY ("mcp_server_id") REFERENCES "public"."deltallm_mcpserver"("mcp_server_id") ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: deltallm_mcptoolpolicy deltallm_mcptoolpolicy_server_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_mcptoolpolicy"
    ADD CONSTRAINT "deltallm_mcptoolpolicy_server_fk" FOREIGN KEY ("mcp_server_id") REFERENCES "public"."deltallm_mcpserver"("mcp_server_id") ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: deltallm_promptbinding deltallm_promptbinding_template_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_promptbinding"
    ADD CONSTRAINT "deltallm_promptbinding_template_fk" FOREIGN KEY ("prompt_template_id") REFERENCES "public"."deltallm_prompttemplate"("prompt_template_id") ON DELETE CASCADE;


--
-- Name: deltallm_promptlabel deltallm_promptlabel_template_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_promptlabel"
    ADD CONSTRAINT "deltallm_promptlabel_template_fk" FOREIGN KEY ("prompt_template_id") REFERENCES "public"."deltallm_prompttemplate"("prompt_template_id") ON DELETE CASCADE;


--
-- Name: deltallm_promptlabel deltallm_promptlabel_version_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_promptlabel"
    ADD CONSTRAINT "deltallm_promptlabel_version_fk" FOREIGN KEY ("prompt_version_id") REFERENCES "public"."deltallm_promptversion"("prompt_version_id") ON DELETE CASCADE;


--
-- Name: deltallm_promptversion deltallm_promptversion_template_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_promptversion"
    ADD CONSTRAINT "deltallm_promptversion_template_fk" FOREIGN KEY ("prompt_template_id") REFERENCES "public"."deltallm_prompttemplate"("prompt_template_id") ON DELETE CASCADE;
...
--
-- Name: deltallm_routegroupmember deltallm_routegroupmember_deployment_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_routegroupmember"
    ADD CONSTRAINT "deltallm_routegroupmember_deployment_fk" FOREIGN KEY ("deployment_id") REFERENCES "public"."deltallm_modeldeployment"("deployment_id") ON DELETE CASCADE;


--
-- Name: deltallm_routegroupmember deltallm_routegroupmember_route_group_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_routegroupmember"
    ADD CONSTRAINT "deltallm_routegroupmember_route_group_fk" FOREIGN KEY ("route_group_id") REFERENCES "public"."deltallm_routegroup"("route_group_id") ON DELETE CASCADE;


--
-- Name: deltallm_routepolicy deltallm_routepolicy_route_group_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."deltallm_routepolicy"
    ADD CONSTRAINT "deltallm_routepolicy_route_group_fk" FOREIGN KEY ("route_group_id") REFERENCES "public"."deltallm_routegroup"("route_group_id") ON DELETE CASCADE;
