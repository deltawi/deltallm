...
Before analyzing, planning, editing, running project commands, or reviewing changes, read [`RULES.md`](RULES.md) completely. It is the canonical repository-wide engineering contract and applies to every task in this repository.
