...
Implicit config grouping is still supported and works as described below. For day-to-day runtime operations, prefer the explicit [Model Groups](../admin-ui/model-groups.md) workflow.
