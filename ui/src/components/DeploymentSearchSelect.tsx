  ...
  return (
    <div ref={wrapperRef} className="space-y-2 relative">
      <button
        ...
        className={`w-full flex items-center justify-between gap-2 px-3 py-2 border border-gray-300 rounded-lg text-sm text-left hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-brand-primary ${inputClassName}`}
