    ...
    <div className="min-h-full bg-[#f5f6f7] pb-12 font-sans text-gray-900">
      <div className="border-b border-gray-200 bg-white px-6 py-5 md:px-8">
        <div className="mx-auto flex max-w-7xl items-start justify-between gap-4">
          <div>
            <h1 className="text-xl font-bold tracking-tight">Tool Approvals</h1>
            <p className="mt-0.5 max-w-2xl text-sm text-gray-500">
              Review and approve pending MCP tool execution requests before they reach the upstream server.
            </p>
          </div>
          <div className="flex flex-shrink-0 items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg border border-gray-200 px-3.5 py-2 text-sm font-medium text-gray-600 transition hover:bg-gray-50 disabled:opacity-40"
            >
      ...
      <div className="mx-auto max-w-7xl space-y-5 px-6 pt-6 md:px-8">
        {pendingCount > 0 ? (
        ...
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span
              className="inline-flex cursor-pointer items-center gap-1.5 rounded-lg border border-gray-200 bg-gray-50 px-2.5 py-1.5 text-xs font-semibold text-gray-600 transition hover:bg-gray-100"
